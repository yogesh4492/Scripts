...
@app.command()
def main(s3path:str=typer.Argument(...,help="Input s3 path for list files"),output_csv:str=typer.Option("f.txt",'-o',help="name of output csv")):
